...
class __TwigTemplate_aeaa09640ef48458b8439c3b9b0fc3ba extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
          ...
          <td>
            ...
            // line 64
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservation_show", ["idreservation" => twig_get_attribute($this->env, $this->source, $context["reservation"], "idreservation", [], "any", false, false, false, 64)]), "html", null, true);
    ...
    <table class=\"table table-striped table-bordered table-hover\">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class=\"btn btn-sm btn-primary\" href=\"{{ path('app_reservation_show', {'idreservation': reservation.idreservation}) }}\" role=\"button\">Détails</a>
