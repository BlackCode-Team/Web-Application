...
class __TwigTemplate_1aa888aabe1b4f1d737693e1a5d9ef52 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "continuez")) : ("continuez")), "html", null, true);
        echo "</button>
";
        // line 4
...
{{ form_end(form) }}
", "reservation/_form.html.twig", "C:\\Users\\Jokser\\Documents\\GitHub\\Web-Application\\Web-Application\\templates\\reservation\\_form.html.twig");
    }
}
