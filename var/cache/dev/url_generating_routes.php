...
return [
    ...
    'app_amende_indexfront' => [[], ['_controller' => 'App\\Controller\\AmendeController::indexfront'], [], [['text', '/amende/front']], [], [], []],
    ...
    'amende_filterfront' => [[], ['_controller' => 'App\\Controller\\AmendeController::filterfront'], [], [['text', '/amende/front/filtre/status']], [], [], []],
    ...
    'app_block_index' => [[], ['_controller' => 'App\\Controller\\BlockedUserController::index'], [], [['text', '/block']], [], [], []],
    'block_user' => [['iduser'], ['_controller' => 'App\\Controller\\BlockedUserController::blockUser'], [], [['variable', '/', '[^/]++', 'iduser', true], ['text', '/block-user']], [], [], []],
    ...
    'app_park_json' => [[], ['_controller' => 'App\\Controller\\ParkController::jsonindex'], [], [['text', '/park/jsonall']], [], [], []],
    'recupjsonpark' => [['idpark'], ['_controller' => 'App\\Controller\\ParkController::parkId'], [], [['text', '/recjson'], ['variable', '/', '[^/]++', 'idpark', true], ['text', '/park']], [], [], []],
    ...
    'app_reservation_json' => [[], ['_controller' => 'App\\Controller\\ReservationController::jsonindex'], [], [['text', '/reservation/jsonall']], [], [], []],
    'app_reservation_show_JSON' => [['idreservation'], ['_controller' => 'App\\Controller\\ReservationController::showJSON'], [], [['text', '/recjson'], ['variable', '/', '[^/]++', 'idreservation', true], ['text', '/reservation']], [], [], []],
    ...
    'app_reservation_showback' => [['idreservation'], ['_controller' => 'App\\Controller\\ReservationController::showadmin'], [], [['variable', '/', '[^/]++', 'idreservation', true], ['text', '/reservation/back']], [], [], []],
    ...
    'search' => [[], ['_controller' => 'App\\Controller\\ReservationController::search'], [], [['text', '/reservation/Search/a']], [], [], []],
    ...
    'app_search_q_r' => [[], ['_controller' => 'App\\Controller\\SearchQRController::index'], [], [['text', '/search']], [], [], []],
    'app_show_pdf' => [['cin'], ['_controller' => 'App\\Controller\\SearchQRController::showPdf'], [], [['variable', '/', '[^/]++', 'cin', true], ['text', '/pdf']], [], [], []],
    'app_login' => [[], ['_controller' => 'App\\Controller\\SecurityController::login'], [], [['text', '/login']], [], [], []],
    'app_logout' => [[], ['_controller' => 'App\\Controller\\SecurityController::logout'], [], [['text', '/logout']], [], [], []],
    'app_user_json' => [[], ['_controller' => 'App\\Controller\\UtilisateurController::jsonindex'], [], [['text', '/utilisateur/jsonall']], [], [], []],
    'recupjsonuser' => [['iduser'], ['_controller' => 'App\\Controller\\UtilisateurController::userId'], [], [['text', '/recjson'], ['variable', '/', '[^/]++', 'iduser', true], ['text', '/utilisateur']], [], [], []],
    'adduserJSON' => [[], ['_controller' => 'App\\Controller\\UtilisateurController::adduserJSON'], [], [['text', '/utilisateur/adduserJSON/new']], [], [], []],
    'deleteusersJSON' => [['id'], ['_controller' => 'App\\Controller\\UtilisateurController::deleteusersJSON'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/utilisateur/deleteusersJSON']], [], [], []],
    'updateuserJSON' => [['id'], ['_controller' => 'App\\Controller\\UtilisateurController::updateuserJSON'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/utilisateur/updateuserJSON']], [], [], []],
    'app_vehicule_index' => [[], ['_controller' => 'App\\Controller\\VehiculeController::index'], [], [['text', '/vehicule/']], [], [], []],
    'app_vehicule_indexJSON' => [[], ['_controller' => 'App\\Controller\\VehiculeController::indexJSON'], [], [['text', '/vehicule/JSON']], [], [], []],
    'app_vehicule_indexback' => [[], ['_controller' => 'App\\Controller\\VehiculeController::indexbackkk'], [], [['text', '/vehicule/indexback']], [], [], []],
    'app_vehicule_back' => [[], ['_controller' => 'App\\Controller\\VehiculeController::indexback'], [], [['text', '/vehicule/back']], [], [], []],
    'searchv' => [[], ['_controller' => 'App\\Controller\\VehiculeController::searchpsrchoix'], [], [['text', '/vehicule/Search/a']], [], [], []],
    ...
    'app_vehicule_newJSON' => [[], ['_controller' => 'App\\Controller\\VehiculeController::newJSON'], [], [['text', '/vehicule/newJSON']], [], [], []],
    'app_vehicule_show' => [['idvehicule'], ['_controller' => 'App\\Controller\\VehiculeController::show'], [], [['variable', '/', '[^/]++', 'idvehicule', true], ['text', '/vehicule']], [], [], []],
    'app_vehicule_showJSON' => [['idvehicule'], ['_controller' => 'App\\Controller\\VehiculeController::showJSON'], [], [['variable', '/', '[^/]++', 'idvehicule', true], ['text', '/vehicule/showJSON']], [], [], []],
    ...
    'app_vehicule_editJSON' => [['idvehicule'], ['_controller' => 'App\\Controller\\VehiculeController::editJSON'], [], [['variable', '/', '[^/]++', 'idvehicule', true], ['text', '/vehicule/editJSON']], [], [], []],
    ...
    'app_vehicule_deleteJSON' => [['idvehicule'], ['_controller' => 'App\\Controller\\VehiculeController::deleteJSON'], [], [['variable', '/', '[^/]++', 'idvehicule', true], ['text', '/vehicule/deleteJSON']], [], [], []],
    ...
    'blocked_user' => [[], ['_controller' => 'App\\Controller\\BlockedUserController::alert'], [], [['text', '/alerteBlock']], [], [], []],
];
