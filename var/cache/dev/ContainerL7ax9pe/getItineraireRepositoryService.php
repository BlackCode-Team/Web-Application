...
<<<<<<<< Updated upstream:var/cache/dev/Container3Nju3es/getItineraireRepositoryService.php
<<<<<<<< Updated upstream:var/cache/dev/ContainerHSNjuhU/getItineraireRepositoryService.php
namespace ContainerHSNjuhU;
========
namespace Container3Nju3es;
>>>>>>>> Stashed changes:var/cache/dev/Container3Nju3es/getItineraireRepositoryService.php
========
namespace ContainerL7ax9pe;
>>>>>>>> Stashed changes:var/cache/dev/ContainerL7ax9pe/getItineraireRepositoryService.php
 ...
 */
class getItineraireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ItineraireRepository' shared autowired service.
     *
     * @return \App\Repository\ItineraireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ItineraireRepository.php';

        return $container->privates['App\\Repository\\ItineraireRepository'] = new \App\Repository\ItineraireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
