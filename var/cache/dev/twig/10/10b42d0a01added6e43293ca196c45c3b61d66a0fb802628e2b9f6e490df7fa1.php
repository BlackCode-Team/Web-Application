...
class __TwigTemplate_d45c529686d0b4906014be4ebc15fa2e3b283abb680b092226701a1eb9527c8e extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_edit", ["idreclamation" => twig_get_attribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 31, $this->source); })()), "idreclamation", [], "any", false, false, false, 31)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "reclamation/show.html.twig", "C:\\Users\\Rania2\\Documents\\Web-Application\\templates\\reclamation\\show.html.twig");
    }
}
