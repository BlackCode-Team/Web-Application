...
<script>
    ...
    var chartData = JSON.parse('";
        // line 14
        echo (isset($context["chartData"]) || array_key_exists("chartData", $context) ? $context["chartData"] : (function () { throw new RuntimeError('Variable "chartData" does not exist.', 14, $this->source); })());
        echo "');
