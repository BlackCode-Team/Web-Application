...
class __TwigTemplate_e400de1b8bd5d23a414f1bf6dd30dd30 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["vehicule"]) {
            ...
            echo "            <tr>
                <td><img src=\"";
            // line 51
            echo twig_escape_filter($this->env, (isset($context["imageSrc"]) || array_key_exists("imageSrc", $context) ? $context["imageSrc"] : (function () { throw new RuntimeError('Variable "imageSrc" does not exist.', 51, $this->source); })()), "html", null, true);
            echo "\" style=\"width:200px;\"></td>
                <td>";
            // line 52
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["vehicule"], "matricule", [], "any", false, false, false, 52), "html", null, true);
            echo "</td>
                <td>";
            // line 53
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["vehicule"], "modele", [], "any", false, false, false, 53), "html", null, true);
            echo "</td>
                <td>";
            // line 54
...
";
    ...
    {
        return array (  121 => 57,  112 => 54,  108 => 53,  104 => 52,  100 => 51,  97 => 50,  93 => 49,  43 => 1,);
    }
...
", "vehicule/catalogue.html.twig", "C:\\Users\\Jokser\\Documents\\GitHub\\Web-Application\\Web-Application\\templates\\vehicule\\catalogue.html.twig");
    }
}
