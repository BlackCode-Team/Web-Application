...
<<<<<<<< Updated upstream:var/cache/dev/Container3Nju3es/getAffectationbadgeRepositoryService.php
<<<<<<<< Updated upstream:var/cache/dev/ContainerHSNjuhU/getAffectationbadgeRepositoryService.php
namespace ContainerHSNjuhU;
========
namespace Container3Nju3es;
>>>>>>>> Stashed changes:var/cache/dev/Container3Nju3es/getAffectationbadgeRepositoryService.php
========
namespace ContainerL7ax9pe;
>>>>>>>> Stashed changes:var/cache/dev/ContainerL7ax9pe/getAffectationbadgeRepositoryService.php
 ...
 */
class getAffectationbadgeRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AffectationbadgeRepository.php';
