    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
            ...
            echo "</td>
               <td>";
            // line 38
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "datedebut", [], "any", false, false, false, 38), "Y-m-d H:m:s"), "html", null, true);
            echo "</td>
               <td>";
            // line 39
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "datefin", [], "any", false, false, false, 39), "Y-m-d H:m:s"), "html", null, true);
            echo "</td>
               <td>";
            // line 40
    ...
    {% block body %}
        ...
        {% for reservation in reservations %}
            <tr>
               ...
               <td>{{ reservation.datedebut|date(\"Y-m-d H:m:s\")}}</td>
               <td>{{ reservation.datefin|date(\"Y-m-d H:m:s\")}}</td>
