...
class __TwigTemplate_210646838ffaaf5eebfcc1968f918bf2355d2d303ea1fe6fbdd35ecdbb09723d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 16, $this->source); })()), "description", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Datereponse</th>
...
{% endblock %}
", "reponse/show.html.twig", "C:\\Users\\Rania2\\Documents\\Web-Application\\templates\\reponse\\show.html.twig");
    }
}
