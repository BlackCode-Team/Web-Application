 ...
 */
final class Version20230426011535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maintenance (idmaintenance INT AUTO_INCREMENT NOT NULL, idvehicule INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_2F84F8E983FAB710 (idvehicule), PRIMARY KEY(idmaintenance)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
