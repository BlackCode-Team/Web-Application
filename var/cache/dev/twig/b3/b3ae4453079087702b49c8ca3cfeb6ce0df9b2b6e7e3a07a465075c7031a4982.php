...
class __TwigTemplate_e5a6f804a8d624e8f188ba203590da4a3b35734880a7903d626569d2427b97bf extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["historiques"]) || array_key_exists("historiques", $context) ? $context["historiques"] : (function () { throw new RuntimeError('Variable "historiques" does not exist.', 16, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["historique"]) {
            ...
            echo "            <tr>
                <td>";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["historique"], "idhistorique", [], "any", false, false, false, 18), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_historique_show", ["idhistorique" => twig_get_attribute($this->env, $this->source, $context["historique"], "idhistorique", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_historique_edit", ["idhistorique" => twig_get_attribute($this->env, $this->source, $context["historique"], "idhistorique", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
