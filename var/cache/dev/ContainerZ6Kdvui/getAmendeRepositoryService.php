 ...
 */
class getAmendeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AmendeRepository' shared autowired service.
     *
     * @return \App\Repository\AmendeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AmendeRepository.php';

        return $container->privates['App\\Repository\\AmendeRepository'] = new \App\Repository\AmendeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
