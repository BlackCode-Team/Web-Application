...
$availabilityData = [
    ...
    'datasets' => [
        ...
        [
            'label' => 'Réservé',
            'data' => [
                count($reserves) >= 1 && $currentHour == 0 ? count($reserves) : 0,
                count($reserves) >= 2 && $currentHour == 1 ? count($reserves) : 0,
                count($reserves) >= 3 && $currentHour == 2 ? count($reserves) : 0,
                count($reserves) >= 4 && $currentHour == 3 ? count($reserves) : 0,
                count($reserves) >= 5 && $currentHour == 4 ? count($reserves) : 0,
                count($reserves) >= 6 && $currentHour == 5 ? count($reserves) : 0,
                0, 
            ],
